...
export const USER = { name: 'Pengguna Office Romeo', short: '', initials: 'OR', email: 'pengguna@officeromeo.id', picture: '' }
export const SKU = { name: 'Office Romeo', detail: 'Aplikasi web & seluler · OneDrive 2 GB' }
