...
export default function FluentShell({
  ...
  search,
  onSearch,
  searchPlaceholder = 'Cari di Microsoft 365',
  onCreate,
  onNotify,
  right,
  children,
    ...
    <div className={`fluent-shell app-${app}`}>
      <header className="fluent-top" ref={topRef}>
        ...
        <div className="fluent-actions">
          ...
          <button className="fluent-icon" onClick={() => onNotify?.('Pengaturan Microsoft 365 F3')} aria-label="Pengaturan"><Settings size={18} /></button>
